        ...
        <div className="flex flex-col gap-[20px] text-center xl:text-left">
            ...
            {experience.items.length === 0 ? (
                <p className="max-w-[600px] text-white/60 mx-auto xl:mx-0 leading-[1.5]">
                    Experienced in executing and completing a graduation thesis
                    project, detailed in the Work section below. This project
                    enhanced my full-stack web development skills, from database
